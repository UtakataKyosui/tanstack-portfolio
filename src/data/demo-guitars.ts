...
const guitars: Array<Guitar> = [
	{
		id: 1,
		name: "Island Signature Ukelele",
		image: "/example-ukelele-tanstack.jpg",
		description:
			"Introducing the Island Signature Ukulele—a beautifully handcrafted concert ukulele that combines exceptional sound quality with distinctive style. Featuring a warm, resonant koa-wood body with natural grain patterns, this instrument delivers the rich, mellow tones Hawaii is famous for. The exclusive palm tree inlay on the soundhole adds a unique touch of island flair, while the matching headstock makes this a true collector's piece for developers and musicians alike. Whether you're a beginner looking for a quality starter instrument or an experienced player wanting something special, this ukulele brings together craftsmanship, character, and that unmistakable tropical spirit.",
		shortDescription:
			"Premium koa-wood ukulele with an exclusive island-inspired inlay, perfect for beach vibes and island-inspired melodies.",
		price: 299,
	},
	{
		id: 2,
